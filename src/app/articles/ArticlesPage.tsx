...
/** Shape that might come back from the backend before we normalize */
...
export default function ArticlePage(): React.JSX.Element {
  ...
  if (!currentArticle) {
    return (
      ...
      >
        <Navbar />
        <h2 className="text-2xl font-semibold">Loading article...</h2>
        <Footer />
      </div>
    </Suspense>
    );
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <article className="mt-6 space-y-8 text-gray-2 00 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {suggested.map((c: Article & { _id?: string | number }) => {
            ...
            return (
              <Link
                key={targetId || Math.random().toString(36).slice(2)}
